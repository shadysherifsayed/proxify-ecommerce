...
print_status "Vite Dev Server URL: http://localhost:${VITE_PORT:-5174}"
print_status "Laravel Telescope URL: http://localhost:${TELESCOPE_PORT:-8000}/telescope"
print_status "Laravel Pulse URL: http://localhost:${PULSE_PORT:-8000}/pulse"
echo ""
